...
import {
  ...
  ImgWrapper,
  LogoTitle,
  PickYourCravingsWrapper,
  Title,
} from "./PickYourCravingsElements";

import { BgOverlay } from "../HomeElements";

const img1 = require("../../../images/home/cravings/Garlic Parmesan Chicken Wings.jpg");
const img2 = require("../../../images/home/cravings/Honey Soy Pepper Glazed Crispy Pata.jpg");
const img3 = require("../../../images/home/cravings/Roasted Filipino Style Chicken.jpg");

const PickYourCravings = () => {
  return (
    <PickYourCravingsWrapper>
      <BgSection>
        <BgContainer>
          <Title>Pick Your Cravings</Title>
        </BgContainer>
        <BgOverlay></BgOverlay>
      </BgSection>
      <svg
      ...
      <ChoicesSection>
        <ChoicesContainer>
          <Column1>
            ...
            <LogoTitle>Chef's Choice</LogoTitle>
          </Column1>
          <Column2>
            <ImgWrapper>
              <Img src={img2} />
            </ImgWrapper>
            <LogoTitle>Home Favorites</LogoTitle>
          </Column2>
          <Column3>
            <ImgWrapper>
              <Img src={img3} />
            </ImgWrapper>
            <LogoTitle>Hot Kitchen Speciality</LogoTitle>
          </Column3>
        </ChoicesContainer>
      </ChoicesSection>
    </PickYourCravingsWrapper>
...
export default PickYourCravings;
